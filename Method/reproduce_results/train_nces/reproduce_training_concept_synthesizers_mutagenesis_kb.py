...
Models = ["GRU_As_MT", "LSTM_As_MT"] #["GRU_As_MT", "LSTM_As_MT"] #["GRU", "LSTM", "CNN"]
...
if final:
    ...
    test = False
    cross_validate = False
experiment.train_all_nets(Models, data_train, data_test, epochs=1000, cs_batch_size=128, tc_batch_size=256, kf_n_splits=10, cross_validate=cross_validate, test=test, save_model = save_model, include_embedding_loss=True, optimizer = 'Adam', tc_label_smoothing=0.9, record_runtime=record_runtime, final=final)
