...
kb_to_data = KBToDataForConceptSynthesis(path=kb_path, concept_gen_path_length=4, max_child_length=8, refinement_expressivity=0.6, downsample_refinements=True, num_rand_samples=300, min_num_pos_examples=1, max_num_pos_examples=2000, num_examples = 1000)
