...
lpg = LearningProblemGenerator(kb_path=kb_path, depth=5, num_rand_samples=50, max_ref_child_length=15, refinement_expressivity=0.2, min_num_pos_examples=1, max_num_pos_examples=2000)
